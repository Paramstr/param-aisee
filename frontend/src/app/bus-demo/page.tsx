      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
          ...
          <div className="xl:col-span-2 space-y-6">
            ...
            <div className="bg-gray-800/50 rounded-xl p-6 border border-gray-700/50">
              <h2 className="text-xl font-semibold text-white mb-4">Video Simulation</h2>
              <div className="aspect-video bg-gray-900/50 rounded-lg border border-gray-700/50 flex items-center justify-center">
                {selectedVideo ? (
                    ...
                    <tbody className="divide-y divide-gray-700/50">
                      {detectionResults.map((result) => (
                        <tr key={result.id} className="hover:bg-gray-700/20">
                          ...
                          <td className="px-4 py-3 text-sm text-gray-300">
                            <div className="w-16 h-12 bg-gray-700 rounded border border-gray-600 flex items-center justify-center text-xs">
